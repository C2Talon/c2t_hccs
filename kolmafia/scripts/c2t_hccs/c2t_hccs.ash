...
boolean c2t_hccs_fightGodLobster() {
	...
	maximize(`mainstat,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`,false);
...
boolean c2t_hccs_preCoil() {
	...
	// equip mp stuff
	maximize(`mp,-equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},-equip {c2t_hccs_pilcrow($item[&quot;i voted!&quot; sticker])}`,false);
...
boolean c2t_hccs_allTheBuffs() {
	...
	// equip mp stuff
	maximize(`mp,-equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])}`,false);
...
boolean c2t_hccs_preItem() {
	string maxstr = `item,2 booze drop,-equip {c2t_hccs_pilcrow($item[broken champagne bottle])},-equip {c2t_hccs_pilcrow($item[surprisingly capacious handbag])},-equip {c2t_hccs_pilcrow($item[red-hot sausage fork])},switch left-hand man`;
	...
	{
		maximize(`mainstat,equip {c2t_hccs_pilcrow($item[latte lovers member's mug])},1000 bonus {c2t_hccs_pilcrow($item[lil' doctor&trade; bag])},1000 bonus {c2t_hccs_pilcrow($item[kremlin's greatest briefcase])},1000 bonus {c2t_hccs_pilcrow($item[vampyric cloake])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`,false);
...
boolean c2t_hccs_preNoncombat() {
	...
	if (have_familiar($familiar[god lobster]) && have_effect($effect[silence of the god lobster]) == 0 && get_property('_godLobsterFights').to_int() < 3) {
		...
		{
			shirt = `,equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])}`;
		}
		maximize(`mainstat,-familiar,100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}` + shirt,false);
...
boolean c2t_hccs_preSpell() {
	...
	if (have_skill($skill[meteor lore]) && have_effect($effect[meteor showered]) == 0 && get_property('_saberForceUses').to_int() < 5) {
		c2t_hccs_levelingFamiliar(true);
		maximize(`mainstat,equip {c2t_hccs_pilcrow($item[fourth of may cosplay saber])}`,false);
		c2t_hccs_freeAdv($location[thugnderdome],-1,"");//everything is saberable and no crazy NCs
	}
...
void c2t_hccs_fights() {
		...
		&& have_effect($effect[tomato power]) == 0)
	{
		...
		if (c2t_hccs_levelingFamiliar(true) == $familiar[melodramedary]
			...
			fam = `,equip {c2t_hccs_pilcrow($item[dromedary drinking helmet])}`;
				...
				&& have_effect($effect[phorcefullness]) == 0))
		{
			...
			if (get_property('lastCopyableMonster').to_monster() != $monster[novelty tropical skeleton]) {
				...
				string temp = `,100 bonus {c2t_hccs_pilcrow($item[jurassic parka])}`;
				if (c2t_hccs_haveCinchoDeMayo())
					temp = "";
				maximize(`mp,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},equip {c2t_hccs_pilcrow($item[latte lovers member's mug])},100 bonus {c2t_hccs_pilcrow($item[vampyric cloake])},100 bonus {c2t_hccs_pilcrow($item[lil' doctor&trade; bag])},100 bonus {c2t_hccs_pilcrow($item[kremlin's greatest briefcase])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+temp+fam,false);
			...
			&& have_effect($effect[tomato power]) == 0)
		{
			if (get_property('lastCopyableMonster').to_monster() != $monster[possessed can of tomatoes]) {
				...
				//max mp to max latte gulp to fuel buffs
				c2t_hccs_levelingFamiliar(true);
				maximize(`mp,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},equip {c2t_hccs_pilcrow($item[latte lovers member's mug])},100 bonus {c2t_hccs_pilcrow($item[vampyric cloake])},100 bonus {c2t_hccs_pilcrow($item[lil' doctor&trade; bag])},100 bonus {c2t_hccs_pilcrow($item[kremlin's greatest briefcase])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+fam,false);
			...
			&& item_amount($item[runproof mascara]) == 0))//to nostalgia runproof mascara
	{
		...
		if (have_familiar($familiar[ghost of crimbo carols]))
			use_familiar($familiar[ghost of crimbo carols]);
		maximize(`mainstat,equip {c2t_hccs_pilcrow($item[latte lovers member's mug])},-equip {c2t_hccs_pilcrow($item[&quot;i voted!&quot; sticker])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`,false);
	...
	{
		maximize(`mainstat,100exp,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},10000 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+fam,false);
		...
		&& get_property("_speakeasyFreeFights").to_int() < 3)
	{
		...
		while (get_property("_speakeasyFreeFights").to_int() < 3 && start == my_turncount()) {
			if (get_property("_sourceTerminalPortscanUses").to_int() > 0)
				maximize(`mainstat,exp,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},-equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},-equip {c2t_hccs_pilcrow($item[&quot;i voted!&quot; sticker])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+fam,false);
			else
				maximize(`mainstat,100exp,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},-equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},-equip {c2t_hccs_pilcrow($item[&quot;i voted!&quot; sticker])},10000 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+fam,false);
	...
	{
		maximize(`mainstat,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},-equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},-equip {c2t_hccs_pilcrow($item[&quot;i voted!&quot; sticker])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+fam,false);
		...
		|| c2t_hccs_freeKillsLeft() > 0)
	{
		...
		if (available_amount($item[lil' doctor&trade; bag]) > 0
			...
			doc = `,equip {c2t_hccs_pilcrow($item[lil' doctor&trade; bag])}`;
		...
		{
			garbage = `,equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])}`;
		}
		else
			garbage = "";
			...
			&& c2t_hccs_pocketProfessorLectures() == 0)
		{
			...
			maximize(`mainstat,equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},100familiar weight,100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+garbage,false);
			restore_hp(my_maxhp());
		}
			...
			&& get_property('lastCopyableMonster').to_monster() == $monster[sausage goblin])
		{
			if (c2t_hccs_haveGarbageTote())
				garbage = `,equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])}`;
			use_familiar($familiar[pocket professor]);
			maximize(`mainstat,equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},100familiar weight,100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])},equip {c2t_hccs_pilcrow($item[backup camera])}`,false);
			restore_hp(my_maxhp());
		}
			...
			&& get_property('lastCopyableMonster').to_monster() == $monster[sausage goblin])
		{
			...
			maximize(`mainstat,exp,equip {c2t_hccs_pilcrow($item[latte lovers member's mug])},equip {c2t_hccs_pilcrow($item[backup camera])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+garbage+fam,false);
			c2t_hccs_freeAdv($location[the dire warren],-1,"");
			...
			&& get_property('lastCopyableMonster').to_monster() == $monster[sausage goblin])
		{
			...
			if (get_property('lastCopyableMonster').to_monster() == $monster[sausage goblin])
				kramco = `,equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])}`;
			else
				kramco = "";
			...
			maximize(`mainstat,exp,equip {c2t_hccs_pilcrow($item[backup camera])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+kramco+garbage+fam,false);
		}
		//rest of the free NEP fights
		else
			maximize(`mainstat,exp,equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+garbage+fam+doc,false);
...
boolean c2t_hccs_wandererFight() {
	...
	string append = `,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},exp`;
	if (c2t_isVoterNow())
	...
	if (c2t_hccs_levelingFamiliar(false) == $familiar[melodramedary])
		append += `,equip {c2t_hccs_pilcrow($item[dromedary drinking helmet])}`;

	set_location($location[the neverending party]);
	maximize(`mainstat,exp,100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+append,false);
	c2t_hccs_freeAdv($location[the neverending party],-1,"");
...
void c2t_hccs_shadowRiftFights() {
	...
	string maxStr = `mainstat,100exp,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},-equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},-equip {c2t_hccs_pilcrow($item[&quot;i voted!&quot; sticker])},100 bonus {c2t_hccs_pilcrow($item[jurassic parka])},10000 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+fam;
...
void c2t_hccs_shadowRiftBoss() {
	...
	string maxStr = `mainstat,exp,-equip {c2t_hccs_pilcrow($item[makeshift garbage shirt])},-equip {c2t_hccs_pilcrow($item[kramco sausage-o-matic&trade;])},-equip {c2t_hccs_pilcrow($item[&quot;i voted!&quot; sticker])},100 bonus {c2t_hccs_pilcrow($item[jurassic parka])},100 bonus {c2t_hccs_pilcrow($item[designer sweatpants])}`+fam;
