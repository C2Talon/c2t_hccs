//BO_sccs hccs
//mostly c2t still but some Big Oli
...
boolean c2t_hccs_allTheBuffs() {
	...
	cli_execute("pillkeeper free stats");
	cli_execute("rest free");
	cli_execute("repeat 8");
...
boolean c2t_hccs_preFamiliar() {
	...
	//Oli add 3
	cli_execute("use 1 silver face paint");
	cli_execute("use 1 Gene Tonic: Construct");
	cli_execute("use 1 shrimp cocktail");
...
boolean c2t_hccs_preSpell() {
	...
	//Oli add 7 2Inner2Elf
		cli_execute("use 1 Gene Tonic: Elf");
		cli_execute("familiar Machine Elf");
		cli_execute("cast 1 blood bubble");
